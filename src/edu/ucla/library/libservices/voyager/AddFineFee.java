...
public class AddFineFee
{
    ...
    throws IOException, ParseException
  {
      ...
      )
    {
      ...
      for (Iterator it = lines.iterator (); it.hasNext (); ) 
      {
        ...
        if (tokens.length >= 4)
        {
          ...
          String itemBarcode = tokens[1];
          String fineFeeType = tokens[2];
          String amount = tokens[3];

          int returnCode = cc.addFineFee(patronId, itemBarcode, fineFeeType, amount);
          if (returnCode != 0)
          {
    ...
    else
    {
      ...
      formatter.printHelp( "AddFineFee", options);
    }
  }
}
